...
async def stats_day(
    ...
    return await build_stats(driver, current_user["id"], start, end, "day")
...
async def stats_week(
    ...
    return await build_stats(driver, current_user["id"], start, end, "week")
...
async def stats_month(
    ...
    return await build_stats(driver, current_user["id"], start, end, "month")
